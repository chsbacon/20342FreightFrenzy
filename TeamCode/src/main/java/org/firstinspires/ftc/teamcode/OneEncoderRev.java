...
public class EncoderTest extends LinearOpMode{
    ...
    public void runOpMode(){
        ...
        while(opModeIsActive()){
          ...
          encoderDrive(DRIVE_SPEED,  20,  20, 30.0);  // one motor rev
    ...
    */
    public void encoderDrive(double speed,
        ...
        newLeftTarget = robot.leftMotor.getCurrentPosition() + (int)(COUNTS_PER_MOTOR_REV*DRIVE_GEAR_REDUCTION);
        newRightTarget = robot.rightMotor.getCurrentPosition() + (int)(COUNTS_PER_MOTOR_REV*DRIVE_GEAR_REDUCTION);
